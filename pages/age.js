    ...
    return (
      <>
        ...
        <div className="flex flex-col items-center justify-center py-2 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mb-4">
            2023년 6월 28일부터 시행된 한국의 만 나이 통일법은 나이 계산
            방식을 변경하였습니다. 이에 따라 만 나이 계산기 웹사이트를
            소개합니다. 해당 웹사이트를 통해 손쉽게 만 나이를 계산할 수
            있습니다.
          </p>

          <h3 className="text-lg font-semibold mb-2">1. 만 나이 계산 방식</h3>
          <p className="mb-4">
            만 나이는 출생일을 기준으로 0살로 시작하여 생일이 지날 때마다
            1살씩 더해가는 방식으로 계산됩니다. 따라서 개인의 생일에 따라 나이가
            달라집니다.
          </p>
          ...
          <p className="mb-4">
            ...
            연도에서 출생 연도를 뺀 값으로 계산됩니다. 연 나이는 특정
            분야에서만 사용되며, 대부분의 경우 만 나이로 통일될 예정입니다.
          </p>
          ...
          <p>
            ...
            계산기로서, 사용자들에게 정확한 만 나이 계산을 제공합니다. 이를
            통해 나이 계산에 관련된 혼동을 방지하고, 한국 사회에서 만 나이의
            표준화를 이루어나가는 데 기여하고자 합니다.
          </p>
        </div>
      </>
    );
